...
import gg.thronebound.dockyard.DockyardServer.Companion.versionInfo
import gg.thronebound.dockyard.registry.registries.MinecraftVersion
...
object Resources {
    ...
    @Deprecated("please use getFile()", ReplaceWith("getFile(path)", "gg.thronebound.dockyard.utils.Resources.getFile"))
