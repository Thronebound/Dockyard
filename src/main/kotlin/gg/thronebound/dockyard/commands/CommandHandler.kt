...
import gg.thronebound.dockyard.extentions.getLegacyTextColorNameFromVanilla
import gg.thronebound.dockyard.extentions.isUppercase
import gg.thronebound.dockyard.extentions.isValidUUID
        ...
        tokens.forEachIndexed { index, value ->
            ...
            argumentData.returnedValue = when (argumentData.expectedReturnValueType) {
                ...
                RegistryBlock::class -> {
                    if (value.contains("[")) {
                        //block state
                        val states = gg.thronebound.dockyard.world.block.Block.parseBlockStateString(value)
                        val block =
