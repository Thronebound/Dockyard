package gg.thronebound.dockyard.entity.metadata

import gg.thronebound.dockyard.entity.Entity
import gg.thronebound.dockyard.entity.TextDisplay
...
fun ByteBuf.writeMetadata(metadata: EntityMetadata) {
    ...
    when(metadata.writer) {
        ...
        EntityMetaValue.BLOCK_STATE -> this.writeVarInt((v as gg.thronebound.dockyard.world.block.Block).getProtocolId())
