package gg.thronebound.dockyard.apis.sidebar
...
class Sidebar(initialTitle: String, initialLines: Map<Int, SidebarLine>) : Viewable(), Disposable, PlayerMessageProvider, PlayerPacketProvider {
    ...
    interface SidebarLine {
        ...
        class Player(var line: (gg.thronebound.dockyard.player.Player) -> String) : SidebarLine {
            fun getValue(player: gg.thronebound.dockyard.player.Player): String = line(player)
        }
    }
