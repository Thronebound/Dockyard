...
import gg.thronebound.dockyard.events.PlayerFinishConsumingEvent
...
@TestFor(PlayerFinishConsumingEvent::class)
class PlayerFinishConsumingEventTest {
    ...
    fun testEventFires() {
        ...
        pool.on<PlayerFinishConsumingEvent> {
            count.countDown()
        }
